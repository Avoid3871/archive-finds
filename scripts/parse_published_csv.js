    ...
    if (cols[0] && cols[1] && (cols[1].includes('$') || cols[1].includes('€'))) {
      ...
      if (name.length > 2 && !name.includes("Sing Up")) {
        products.push({
          ...
          affiliateUrl: `https://www.sugargoo.com/#/home/productDetail?productLink=${encodeURIComponent('https://item.taobao.com/item.htm?id=search&name=' + encodeURIComponent(name))}&memberId=1325437696506389977`,
